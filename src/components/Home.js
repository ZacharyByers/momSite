...
import momFace from '../images/momFace.jpeg';
  ...
  const boxText = `Go to the Contact Me page to book an appointment and we'll get you going on an incredible journey! Choose from a single session or buy a package of 3, 6 or 10.`
